...
public class EnAes {
	...
	public static void main(String[] args) throws Exception, UnsupportedEncodingException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException{
		EnAes enTest= new EnAes();
		String enStr = enTest.encrypt("dxf", "1234567890123456");
		System.out.println(enStr);
		System.out.println(enTest.decrypt(enStr, "1234567890123456"));
	}
}
