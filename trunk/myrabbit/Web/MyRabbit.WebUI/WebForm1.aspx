<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="SINOMA.WebUI.WebForm1" %>
...
<body>
    ...
    <asp:HyperLink runat="server" ID="hykDownload" Text="download" NavigateUrl="~/ExcelTemplate/WebForm1.aspx"></asp:HyperLink>
    </form>
</body>
</html>
