...
SECRET_KEY = '=lm5fim4qlw@!5=1+0_y3%yfnynb%st&nnk8jcsmkjz7-t1ro^'
...
HERE = os.path.dirname(os.path.dirname(__file__)).decode('utf-8').replace('\\','/')
...
TEMPLATE_DIRS= (os.path.join(HERE,'templates').replace('\\','/'),) #"D:/Workspace/ecomstore/templates"
