		...
		validate : function(a) {
			if (this.length) {
				...
				if (b.settings.onsubmit) {
					this.find("input, button").filter(".cancel").click(
							function() {
								b.cancelSubmit = true
							});
	...
	c.extend(c.validator, {
		...
		prototype : {
			init : function() {
				...
				this.containers = c(this.settings.errorContainer)
			...
			focusInvalid : function() {
				if (this.settings.focusInvalid)
					try {
						c(this.findLastActive() || this.errorList.length
			...
			elements : function() {
				var a = this, b = {};
				return c(this.currentForm).find("input, select, textarea")
			...
			check : function(a) {
				...
				for (e in b) {
					...
					try {
						var g = c.validator.methods[e].call(this, a.value
										.replace(/\r/g, ""), a, f.parameters);
			...
			showLabel : function(a, b) {
				...
				if (d.length) {
					...
					if (this.settings.wrapper)
						d = d.hide().show().wrap("<" + this.settings.wrapper
								+ "/>").parent();
		...
		addMethod : function(a, b, d) {
			...
			c.validator.messages[a] = d != undefined
					? d
				...
				c.ajax(c.extend(true, {
							...
							success : function(h) {
								...
								if (j) {
									...
									i[b.name] = e.message = c.isFunction(h)
											? h(a)
											: h;
									f.showErrors(i)
								}
