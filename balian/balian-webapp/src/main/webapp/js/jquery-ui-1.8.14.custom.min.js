...
(function(b) {
	...
	b.widget("ui.button", {
		...
		_setOption : function(a, c) {
			...
			if (a === "disabled")
				c ? this.element.attr("disabled", true) : this.element
						.removeAttr("disabled");
			else
				this._resetButton()
		},
		...
		create : function(a) {
			if (this.instances.length === 0) {
				...
				c(document).bind("keydown.dialog-overlay", function(d) {
					if (a.options.closeOnEscape && d.keyCode
...
(function(d) {
	d.widget("ui.slider", d.ui.mouse, {
		...
		_create : function() {
			var b = this, a = this.options, c = this.element
					.find(".ui-slider-handle")
					.addClass("ui-state-default ui-corner-all"), f = a.values
					&& a.values.length || 1, e = [];
			...
			this.element.addClass("ui-slider ui-slider-" + this.orientation
					...
					+ (a.disabled ? " ui-slider-disabled ui-disabled" : ""));
			this.range = d([]);
			if (a.range) {
				if (a.range === true) {
					if (!a.values)
			...
			this.handles.keydown(function(g) {
				...
				if (!b.options.disabled) {
					...
					m = b.options.step;
					i = b.options.values && b.options.values.length ? (h = b
							.values(l)) : (h = b.value());
					switch (g.keyCode) {
						case d.ui.keyCode.HOME :
							h = b._valueMin();
		...
		_mouseCapture : function(b) {
			...
			a = e.offset();
			this._clickOffset = !d(b.target).parents().andSelf()
					.is(".ui-slider-handle") ? {
				left : 0,
				top : 0
			} : {
				left : b.pageX - a.left - e.width() / 2,
				top : b.pageY - a.top - e.height() / 2
		...
		_normValueFromMouse : function(b) {
			...
			if (this.orientation === "horizontal") {
				...
				b = b.x - this.elementOffset.left
						- (this._clickOffset ? this._clickOffset.left : 0)
			} else {
				a = this.elementSize.height;
				b = b.y - this.elementOffset.top
		...
		_refreshValue : function() {
			var b = this.options.range, a = this.options, c = this, f = !this._animateOff
					? a.animate
					: false, e, j = {}, g, k, l, i;
			if (this.options.values && this.options.values.length)
...
(function(d, C) {
	...
	d.extend(M.prototype, {
		...
		_showDatepicker : function(a) {
			...
			if (!(d.datepicker._isDisabledDatepicker(a) || d.datepicker._lastInput == a)) {
				...
				if (!b.inline) {
					...
					d.effects && d.effects[c] ? b.dpDiv.show(c, d.datepicker
									._get(b, "showOptions"), f, h) : b.dpDiv[c
							|| "show"](c ? f : null, h);
					if (!c || !f)
						h();
		...
		_generateHTML : function(a) {
			...
			var q = this._get(a, "dayNamesMin"), B = this._get(a, "monthNames"), v = this
		...
		_generateMonthYearHeader : function(a, b, c, e, f, h, i, g) {
			...
			if (h || !j)
				...
				o += '<select class="ui-datepicker-month" onchange="DP_jQuery_'
						+ A + ".datepicker._selectMonthYear('#" + a.id
						+ "', this, 'M');\" onclick=\"DP_jQuery_" + A
	...
	f.extend(f.effects, {
				...
				createWrapper : function(c) {
					...
					if (c.css("position") == "static") {
						...
						f.each(["top", "left", "bottom", "right"], function(d,
										e) {
									a[e] = c.css(e);
